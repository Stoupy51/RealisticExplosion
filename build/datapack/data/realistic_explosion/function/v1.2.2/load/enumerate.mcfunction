...
#> realistic_explosion:v1.2.2/load/enumerate
#
...
execute if score #realistic_explosion.major load.status matches 1 if score #realistic_explosion.minor load.status matches 2 unless score #realistic_explosion.patch load.status matches 2.. run scoreboard players set #realistic_explosion.patch load.status 2

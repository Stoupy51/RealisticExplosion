...
#> realistic_explosion:generated_summons/32
#
...
execute if data storage realistic_explosion:main {id:"minecraft:blue_glazed_terracotta"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:blue_glazed_terracotta"}
execute if data storage realistic_explosion:main {id:"minecraft:chiseled_nether_bricks"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:chiseled_nether_bricks"}
execute if data storage realistic_explosion:main {id:"minecraft:chiseled_red_sandstone"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:chiseled_red_sandstone"}
execute if data storage realistic_explosion:main {id:"minecraft:cobbled_deepslate_slab"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:cobbled_deepslate_slab"}
execute if data storage realistic_explosion:main {id:"minecraft:cobbled_deepslate_wall"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:cobbled_deepslate_wall"}
execute if data storage realistic_explosion:main {id:"minecraft:crimson_pressure_plate"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:crimson_pressure_plate"}
execute if data storage realistic_explosion:main {id:"minecraft:cut_red_sandstone_slab"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:cut_red_sandstone_slab"}
execute if data storage realistic_explosion:main {id:"minecraft:cyan_glazed_terracotta"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:cyan_glazed_terracotta"}
execute if data storage realistic_explosion:main {id:"minecraft:dark_prismarine_stairs"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:dark_prismarine_stairs"}
execute if data storage realistic_explosion:main {id:"minecraft:dead_brain_coral_block"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:dead_brain_coral_block"}
execute if data storage realistic_explosion:main {id:"minecraft:deepslate_brick_stairs"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:deepslate_brick_stairs"}
execute if data storage realistic_explosion:main {id:"minecraft:deepslate_redstone_ore"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:deepslate_redstone_ore"}
execute if data storage realistic_explosion:main {id:"minecraft:end_stone_brick_stairs"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:end_stone_brick_stairs"}
...
execute if data storage realistic_explosion:main {id:"minecraft:stripped_pale_oak_wood"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:stripped_pale_oak_wood"}
execute if data storage realistic_explosion:main {id:"minecraft:stripped_warped_hyphae"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:stripped_warped_hyphae"}
execute if data storage realistic_explosion:main {id:"minecraft:waxed_weathered_copper"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:waxed_weathered_copper"}
execute if data storage realistic_explosion:main {id:"minecraft:weathered_copper_chain"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:weathered_copper_chain"}

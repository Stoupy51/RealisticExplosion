...
execute if data storage realistic_explosion:main {id:"minecraft:cut_red_sandstone"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:cut_red_sandstone"}
execute if data storage realistic_explosion:main {id:"minecraft:dark_oak_trapdoor"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:dark_oak_trapdoor"}
execute if data storage realistic_explosion:main {id:"minecraft:daylight_detector"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:daylight_detector"}
...
execute if data storage realistic_explosion:main {id:"minecraft:light_blue_carpet"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:light_blue_carpet"}
...
execute if data storage realistic_explosion:main {id:"minecraft:nether_brick_wall"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:nether_brick_wall"}
execute if data storage realistic_explosion:main {id:"minecraft:nether_quartz_ore"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:nether_quartz_ore"}
execute if data storage realistic_explosion:main {id:"minecraft:nether_wart_block"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:nether_wart_block"}
execute if data storage realistic_explosion:main {id:"minecraft:orange_terracotta"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:orange_terracotta"}
execute if data storage realistic_explosion:main {id:"minecraft:pale_hanging_moss"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:pale_hanging_moss"}
...
execute if data storage realistic_explosion:main {id:"minecraft:warped_fence_gate"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:warped_fence_gate"}
execute if data storage realistic_explosion:main {id:"minecraft:warped_wart_block"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:warped_wart_block"}
execute if data storage realistic_explosion:main {id:"minecraft:waxed_copper_bars"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:waxed_copper_bars"}

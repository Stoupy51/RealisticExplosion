...
execute if data storage realistic_explosion:main {id:"minecraft:chiseled_deepslate"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:chiseled_deepslate"}
execute if data storage realistic_explosion:main {id:"minecraft:chiseled_sandstone"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:chiseled_sandstone"}
...
execute if data storage realistic_explosion:main {id:"minecraft:mossy_stone_bricks"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:mossy_stone_bricks"}
...
execute if data storage realistic_explosion:main {id:"minecraft:resin_brick_stairs"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:resin_brick_stairs"}
execute if data storage realistic_explosion:main {id:"minecraft:small_amethyst_bud"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:small_amethyst_bud"}
execute if data storage realistic_explosion:main {id:"minecraft:smooth_quartz_slab"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:smooth_quartz_slab"}
execute if data storage realistic_explosion:main {id:"minecraft:stone_brick_stairs"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:stone_brick_stairs"}
execute if data storage realistic_explosion:main {id:"minecraft:stripped_birch_log"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:stripped_birch_log"}
execute if data storage realistic_explosion:main {id:"minecraft:waxed_copper_block"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:waxed_copper_block"}
execute if data storage realistic_explosion:main {id:"minecraft:waxed_copper_chain"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:waxed_copper_chain"}

...
execute if data storage realistic_explosion:main {id:"minecraft:light_blue_concrete_stairs"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:light_blue_concrete_stairs"}
...
execute if data storage realistic_explosion:main {id:"minecraft:light_gray_concrete_stairs"} run summon falling_block ~ ~ ~ {Tags:["realistic_explosion.new"],DropItem:0b,BlockState:"minecraft:light_gray_concrete_stairs"}
